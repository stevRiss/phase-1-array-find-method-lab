...
function superbowlWin(winLoss){
    for(let item of winLoss){
        let winYears = winLoss.find(item => item.result === "W");
        if(winYears){
            return winYears.year;
        }
        else{return undefined;}
    }
        // let didntMake = winLoss.find(item => item.result === "N/A");
        // let loss = winLoss.find(item => item.result === "L" );

        // if(item.result === "W"){
        //     return winYears.year;
            
        // }else if (item.result === "L" || item.result === "N/A"){
        //              item = undefined;
        //              return item;
        //         }
    ...
    //     let didntMake = winLoss.find(item => item.result === "N/A");
    //     let loss = winLoss.find(item => item.result === "L" );
    //     if (item.result === "L" || item.result === "N/A"){
    //         item = undefined;
    //     }
    //         return;
    // }
